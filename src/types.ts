...
export interface IUserRecord { // User in Users Table that created by cognito/lambda-container/post-sign-up/index.mjs
  user_name: string,
  passport_num: string,
...
export interface IForeignTableRecord { // Full Interface can be found in server/src/services/users/user.types.ts
  foreign_key: string,
  General_details: {
    nationality: string;
